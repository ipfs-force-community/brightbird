...
// WithJobID adds the jobID to the list tasks params
func (o *ListTasksParams) WithJobID(jobID *string) *ListTasksParams {
	o.SetJobID(jobID)
	return o
}

// SetJobID adds the jobId to the list tasks params
func (o *ListTasksParams) SetJobID(jobID *string) {
	o.JobID = jobID
}
