...
UploadPluginParams contains all the parameters to send to the API endpoint
	...
	for the upload plugin operation.
...
// WithDefaults hydrates default values in the upload plugin params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadPluginParams) WithDefaults() *UploadPluginParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the upload plugin params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UploadPluginParams) SetDefaults() {
